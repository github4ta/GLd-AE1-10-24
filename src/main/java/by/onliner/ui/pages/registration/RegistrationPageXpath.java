...
public class RegistrationPageXpath {
    ...
    public static final String MESSAGE_TO_ENTER_PASSWORD_MIN_8_CHAR = "//div[@class=\"auth-form__securebox auth-form__securebox_condensed\"][1]";
    public static final String INPUT_REPEAT_PASSWORD = "//input[@type=\"password\"][@placeholder=\"Повторите пароль\"]";
}