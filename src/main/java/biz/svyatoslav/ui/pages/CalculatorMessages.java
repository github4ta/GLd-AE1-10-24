...
public class CalculatorMessages {
    ...
    public static final String NO_DATA = NO_NAME + VALID_HEIGHT + VALID_WEIGHT + "\n" + NO_GENDER;
    ...
    public static final String NO_NAME_VALID_HEIGHT_VALID_WEIGHT = NO_NAME + VALID_HEIGHT + VALID_WEIGHT;
}
